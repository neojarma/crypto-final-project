...
public class FinalApplication {
	public static void main(String[] args) throws Exception{
		...
		while(isContinue) {
			System.out.println("Registered as User 1");
			System.out.println("\nMenu: ");
	...
	public static void sendMessage() throws Exception{
		...
		PublicKey pubsKey = Crypto.stringToPublicKey(TempStorage.userOnePubsKey);
	...
	public static void readMessage() throws Exception {
		PrivateKey privKey = Crypto.stringToPrivateKey(TempStorage.userTwoPrivKey);
		Scanner input = new Scanner(System.in);
